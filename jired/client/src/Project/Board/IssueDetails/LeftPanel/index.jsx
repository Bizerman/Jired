  ...
  return (
    <LeftContainer>
      <MainBlock>
        ...
        <DescriptionBlock>
          ...
          {isEditing ? (
            ...
            <DescriptionDisplay
              dangerouslySetInnerHTML={{ __html: issue.description || t('noDescription') }}
            />
          )}
        </DescriptionBlock>
      </MainBlock>
      ...
      {!isEditing && (
        <>
          <ActivitySection>
            <ActivityHeader>{t('activity')}</ActivityHeader>
            <ShowRow>
              <ShowLabel>{t('showLabel')}</ShowLabel>
              <FilterButtons>
                <FilterButton active={activeFilter === 'All'} onClick={() => setActiveFilter('All')}>{t('all')}</FilterButton>
                <FilterButton active={activeFilter === 'Comments'} onClick={() => setActiveFilter('Comments')}>{t('comments')}</FilterButton>
                <FilterButton active={activeFilter === 'History'} onClick={() => setActiveFilter('History')}>{t('history')}</FilterButton>
                <FilterButton active={activeFilter === 'Work log'} onClick={() => setActiveFilter('Work log')}>{t('workLog')}</FilterButton>
              </FilterButtons>
